    ...
    return (
      <div className="bg-neutral-900 rounded-xl border border-neutral-800 p-6">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-white capitalize">{tier} Partner</div>
                    <div className="text-sm text-neutral-400">{info.stakeAmount / 1_000_000}M $UNSYS</div>
                  </div>
                  <div className="text-emerald-400 font-medium">{info.revenueShare * 100}% revenue</div>
                </div>
              </button>
            );
          })}
        ...
        {selectedTier && (
          <div className="mb-6">
            <label className="block text-sm text-neutral-400 mb-2">
              Solana Wallet Address (for $UNSYS)
            </label>
            <input
              type="text"
              value={walletAddress}
            ...
            <p className="text-xs text-neutral-500 mt-2">
              In production, this would verify your token balance on-chain. Currently using mock verification.
            </p>
          </div>
        )}
        ...
        <div className="flex gap-3">
          ...
          >
            {staking ? "Processing..." : "Stake & Become Partner"}
    ...
    <div className="bg-neutral-900 rounded-xl border border-neutral-800 p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Become an openLesson Partner</h3>
            <p className="text-sm text-neutral-400">Earn revenue from your referrals</p>
          </div>
        </div>
        {onClose && (
          <button onClick={onClose} className="text-neutral-400 hover:text-white">
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-6">
        {(["bronze", "silver", "gold"] as PartnerTier[]).map((tier) => {
          ...
          return (
            ...
            >
              <div className="text-sm font-medium text-white capitalize mb-1">{tier}</div>
              ...
              <div className="text-xs text-neutral-500">revenue share</div>
            </div>
          );
        })}
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-neutral-400 mt-1 space-y-1">
              <li>• Stake $UNSYS to unlock your tier</li>
              <li>• Share your unique invite link</li>
              <li>• Earn {PARTNER_TIERS.bronze.revenueShare * 100}-{PARTNER_TIERS.gold.revenueShare * 100}% of subscription revenue</li>
