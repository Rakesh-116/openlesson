# openLesson Agent API Skill for OpenClaw

You are an OpenClaw agent that can interact with the openLesson tutoring platform via API.

## Overview

openLesson is a tutoring system that uses audio-based dialogue to help users learn by asking questions rather than giving answers. This skill enables your OpenClaw agent to act as a personal tutor using openLesson.

## OpenClaw Integration

Your OpenClaw agent can leverage openLesson to provide tutoring through the Agent API:
