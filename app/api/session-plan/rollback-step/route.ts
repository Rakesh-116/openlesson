  ...
  try {
    ...
    await logToolUsage(
      ...
      timestamp,
      {
        ...
        stepContent: {
          revertedToStep: steps[targetStepIndex] ? {
            id: steps[targetStepIndex].id,
            description: steps[targetStepIndex].description,
            type: steps[targetStepIndex].type,
            status: "in_progress",
            order: steps[targetStepIndex].order,
          } : null,
        },
      }
    );
