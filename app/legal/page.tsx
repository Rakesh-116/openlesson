...
export const metadata = {
  ...
  description: "Legal Notice and company information for openLesson",
};
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="space-y-8 text-sm text-neutral-400 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>The openLesson brand name and design</li>
          ...
          <section>
            ...
            <p>
              ...
              transcripts, and session data. By using openLesson, users grant Uncertain Systems
          ...
          <section>
            ...
            <p>
              openLesson uses artificial intelligence models provided by third parties (via OpenRouter).
              Users acknowledge that:
            </p>
            <ul className="list-disc pl-5 space-y-1 mt-3">
              <li>AI-generated questions and reports may be inaccurate or incomplete</li>
              <li>openLesson is not a substitute for professional education or tutoring</li>
